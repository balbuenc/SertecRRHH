<%@ Page Language="VB" AutoEventWireup="false" CodeFile="busca_funcionarios.aspx.vb" Inherits="busca_funcionarios" %>
...
<head runat="server">
    <script language="javascript">
        ...
        {
            window.opener.location.href = "man_funcionarios_tab.aspx?cod_funcionario="+id;
            window.close();
        }

        function Seleccionar_update(id) {
            window.opener.location.href = "man_funcionarios_tab_update.aspx?cod_funcionario=" + id;
            window.close();
        }
    </script>
<base target="_parent" />
        ...
        <tr>
            ...
            <asp:SqlDataSource ID="funcionarios_con" runat="server" 
                ConnectionString="<%$ ConnectionStrings:payrollConnectionString %>" 
                                ...
                                SelectCommand="SELECT cod_funcionario, codigo, ISNULL(apellidos, ' ') + ', ' + ISNULL(nombres, ' ') AS funcionario FROM funcionarios WHERE (cod_empresa = @cod_empresa) AND (apellidos LIKE @campo + '%') OR (cod_empresa = @cod_empresa) AND (codigo LIKE @campo)">
                <SelectParameters>

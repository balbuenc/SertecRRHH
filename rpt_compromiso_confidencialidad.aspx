<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="rpt_compromiso_confidencialidad.aspx.vb" Inherits="rpt_compromiso_confidencialidad" %>
                        ...
                        <table align="center" style="width: 590px; height: 121px;" width="64%">
                            <tr>
                                <td align="right" class="style19" 
                                    ...
                                    width="525">
                                    Compromiso de Confidencialidad</td>
                                <td rowspan="5" style="text-align: left">
                                    <asp:ImageButton ID="ImageButton1" runat="server" 
                                        ImageUrl="~/images/controles/find.png" 
                                        onclientclick="var wBusqueda = window.open('busca_funcionarios_compromiso.aspx','wBusqeuda','width=500,height=500, left = 262, top = 134');return false" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="right" height="30" 
                                    ...
                                    <asp:FormView ID="form_funcionarios" runat="server" 
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="funcionariosLabel" runat="server" Font-Bold="True" 
                                                Font-Size="X-Large" ForeColor="#0066FF" Text='<%# Bind("funcionarios") %>' 
                                                Width="100%" />
                                            <br />
                                        </ItemTemplate>
                                    </asp:FormView>

<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="rpt_recibo_liquidacion_aguinaldo.aspx.vb" Inherits="rpt_recibo_liquidacion" %>
            ...
            <table align="center">
                <tr>
                    <td colspan="2" align="center" width="100%" 
                        ...
                        Emisión de Recibos Aguinaldo</td>
                </tr>
                <tr>
                    <td>
                        &nbsp;</td>
    ...
    <tr>
        <td align="center">
            <asp:SqlDataSource ID="funcionarios_con" runat="server" 
                ...
                SelectCommand="SELECT cod_funcionario, codigo, ISNULL(apellidos, ' ') + ', ' + ISNULL(nombres, ' ') AS funcionario FROM funcionarios WHERE (tipo_remuneracion = 'M') AND (cod_empresa = @cod_empresa) AND (apellidos LIKE @campo + '%') OR (tipo_remuneracion = 'M') AND (cod_empresa = @cod_empresa) AND (codigo LIKE @campo)">
                <SelectParameters>

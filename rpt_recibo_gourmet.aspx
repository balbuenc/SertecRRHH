<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="rpt_recibo_gourmet.aspx.vb" Inherits="rpt_recibo_gourmet" %>
                    ...
                    <table align="center">
                        <tr>
                            <td colspan="2" align="center" width="100%" 
                                ...
                                Emisión de Recibos Gourmet Card</td>
                        </tr>
                        <tr>
                            <td>
                                &nbsp;</td>
                        ...
                        <tr>
                            <td class="label" align="left" colspan="2" style="border: 1px dashed #C0C0C0">
                                <asp:CheckBox ID="ck_todos" runat="server" 
    Text="Todos" AutoPostBack="True" />
                                <asp:RadioButtonList ID="rb_orden" runat="server" RepeatDirection="Horizontal" 
                                    Width="200px">

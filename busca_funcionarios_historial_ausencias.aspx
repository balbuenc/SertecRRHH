<%@ Page Language="VB" AutoEventWireup="false" CodeFile="busca_funcionarios_historial_ausencias.aspx.vb" Inherits="busca_funcionarios" %>
...
<head runat="server">
    <script language="javascript">
        ...
        {
            window.opener.location.href = "man_historial_ausencias.aspx?cod_funcionario="+id;
            window.close();
        }
    </script>
<base target="_parent" />

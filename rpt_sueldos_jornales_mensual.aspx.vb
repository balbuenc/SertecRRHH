...
Partial Class rpt_sueldos_jornales_mensual
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            rb_tipo_planilla.SelectedIndex = 0
    ...
    Protected Sub img_procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles img_procesar.Click
        ...
        'se genera la url
        Dim url As String
        If rb_tipo_planilla.SelectedValue = "D" Then
            url = lb_server.Text + "?" + _
            "/planillas/" + "planilla_suel_jor_mensual_detallado" + _
            RENDER_COMMAND
        ElseIf rb_tipo_planilla.SelectedValue = "R" Then
            url = lb_server.Text + "?" + _
            "/planillas/" + "planilla_suel_jor_mensual_resumido" + _
            RENDER_COMMAND
        End If

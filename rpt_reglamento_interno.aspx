<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="rpt_reglamento_interno.aspx.vb" Inherits="rpt_reglamento_interno" %>
                            ...
                            <tr>
                                ...
                                <td rowspan="5" style="text-align: left">
                                    <asp:ImageButton ID="ImageButton1" runat="server" 
                                        ...
                                        onclientclick="var wBusqueda = window.open('busca_funcionarios_reglamento.aspx','wBusqeuda','width=500,height=500, left = 262, top = 134');return false" />
                                </td>
                            </tr>
                            <tr>

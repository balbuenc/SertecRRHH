<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="rpt_certificado_remuneracion.aspx.vb" Inherits="rpt_certificado_remuneracion" %>
                        ...
                        <table align="center" style="width: 590px; height: 121px;" width="64%">
                            <tr>
                                <td align="right" class="style19" 
                                    ...
                                    width="525">
                                    Certificado de Remuneración</td>
                                <td rowspan="5" style="text-align: left">
                                    <asp:ImageButton ID="ImageButton1" runat="server" 
                                        ImageUrl="~/images/controles/find.png" 
                                        onclientclick="var wBusqueda = window.open('busca_funcionarios_certificado_remuneracion.aspx','wBusqeuda','width=500,height=500, left = 262, top = 134');return false" />
                                </td>
                            </tr>
                            <tr>

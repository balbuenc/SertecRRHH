...
Partial Class rpt_certificado_laboral
    ...
    Protected Sub img_generar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles img_generar.Click
        ...
        Dim v_presentado As String

        'se genera la url
        Dim url As String
        url = lb_server.Text + "?" + _
            "/certificados/" + "certificado_horario_laboral" + _
            RENDER_COMMAND

        v_empresa = Session("sv_empresa").ToString
        v_presentado = txt_presentado.Text

        v_funcionario = hf_cod_funcionario.Value
        url += "&p_cod_funcionario=" + v_funcionario + "&p_cod_empresa=" + v_empresa + "&p_cod_empresa=" + v_empresa + "&p_presentado=" + v_presentado

<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="diskette_canasta.aspx.vb" Inherits="Default2" %>
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        style="border: 1px dashed #000000; font-family: 'Trebuchet MS'; font-size: medium; font-weight: bold; ">
                            Generación de Diskettes para el Banco - Ticket Canasta</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: left" valign="middle" class="style14">
                            <asp:TextBox ID="txt_acreditacion" runat="server" Width="350px"></asp:TextBox>
                        </td>
                    </tr>

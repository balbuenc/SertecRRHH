...
Partial Class rpt_recibo_liquidacion
    ...
    Protected Sub ImageButton2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        'se genera la url
        Dim url As String
        url = lb_server.Text + "?/EnigmaSSRS/recibo_liquidacion" + RENDER_COMMAND

        v_empresa = Session("sv_empresa").ToString
        v_fecha = dd_fecha.Value

        If ck_todos.Checked = True Then
            url += "&p_opcion=T&p_cod_funcionario=0&cod_empresa=" + v_empresa + "&p_cod_empresa=" + v_empresa + "&p_fecha_liq=" + v_fecha
        ElseIf ck_todos.Checked = False Then
            ...
            Else
                ...
                url += "&p_opcion=U&p_cod_funcionario=" + v_funcionario + "&cod_empresa=" + v_empresa + "&p_cod_empresa=" + v_empresa + "&p_fecha_liq=" + v_fecha
            End If
        End If

<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="rpt_recibo_liquidacion_egreso.aspx.vb" Inherits="rpt_recibo_liquidacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    Text="Todos" AutoPostBack="True" Visible="False" />
                    </td>
                </tr>
                <tr>
                    <td class="label">
    ...
    <tr>
        <td align="center">
            <asp:SqlDataSource ID="funcionarios_con" runat="server" 
                ...
                SelectCommand="SELECT cod_funcionario, codigo, ISNULL(apellidos, ' ') + ', ' + ISNULL(nombres, ' ') AS funcionario FROM funcionarios WHERE (estado = 'E') AND (tipo_remuneracion = 'M') AND (cod_empresa = @cod_empresa) AND (apellidos LIKE @campo + '%') OR (estado = 'E') AND (tipo_remuneracion = 'M') AND (cod_empresa = @cod_empresa) AND (codigo LIKE @campo)">
                <SelectParameters>

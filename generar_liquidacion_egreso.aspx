<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false" CodeFile="generar_liquidacion_egreso.aspx.vb" Inherits="generar_liquidacion" %>
    ...
    <tr>
        <td>
                        ...
                        style="border: 1px dashed #000000; font-family: 'Trebuchet MS'; font-size: medium; font-weight: bold; ">
                                                        Generación de Liquidación Egreso</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        &nbsp;</td>
                                                        ...
                                                        <table align="center">
                                                            <tr>
                                                                <td align="right" class="label">
                                                                    Tipo de Egreso:</td>
                                                                <td align="left">
                                                                    <asp:DropDownList ID="ddl_t_finiquito" runat="server">
                                                                        <asp:ListItem Value="DJ">DESPIDO JUSTIFICADO</asp:ListItem>
                                                                        <asp:ListItem Value="DI">DESPIDO INJUSTIFICADO</asp:ListItem>
                                                                        <asp:ListItem Value="RE">RENUNCIA</asp:ListItem>
                                                                        <asp:ListItem Value="TC">TERMINO DE CONTRATO</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table align="center">
                                                            <tr>
                                                                <td align="right" class="label">
                                                                    Motivo:</td>
                                                                <td align="left">
                                                                    <asp:TextBox ID="txt_motivo" runat="server" Width="320px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="busca_funcionarios_contrato_individual.aspx.vb" Inherits="busca_funcionarios" %>
...
<head runat="server">
    <script language="javascript">
        ...
        {
            window.opener.location.href = "rpt_contrato_individual.aspx?cod_funcionario=" + id;
            window.close();
        }
    </script>
<base target="_parent" />

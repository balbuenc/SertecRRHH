<%@ Page Language="VB" AutoEventWireup="false" CodeFile="busca_funcionarios_prestamos.aspx.vb" Inherits="busca_funcionarios" %>
...
<head runat="server">
    <script language="javascript">
        ...
        {
            window.opener.location.href = "man_funcionarios_prestamos.aspx?cod_funcionario="+id;
            window.close();
        }

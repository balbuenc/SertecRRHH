<%@ Page Title="" Language="VB" MasterPageFile="~/menu_master.master" AutoEventWireup="false"
    CodeFile="generar_liquidacion_aguinaldo.aspx.vb" Inherits="generar_liquidacion" %>
...
<%@ Register Assembly="Infragistics35.WebUI.WebSchedule.v8.3, Version=8.3.20083.1009, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb"
    Namespace="Infragistics.WebUI.WebSchedule" TagPrefix="igsch" %>
                        ...
                        <table align="center">
                            ...
                            <tr>
                                <td colspan="2" align="center" width="100%" style="border: 1px dashed #000000; font-family: 'Trebuchet MS';
                                    ...
                                    Generación de Liquidación Aguinaldo
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td class="label" align="left" colspan="2">
                                    <asp:CheckBox ID="ck_todos" runat="server" Text="Todos" AutoPostBack="True" />
                                </td>
                            </tr>
                            <tr>
                                <td class="label">
                                ...
                                <td>
                                    <asp:ImageButton ID="ib_buscar" runat="server" ImageUrl="~/images/controles/find.png"
                                        ToolTip="Buscar" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center">
                                    <asp:GridView ID="grilla_funcionarios" runat="server" AutoGenerateColumns="False"
                                        DataKeyNames="cod_funcionario" DataSourceID="funcionarios_con" AllowPaging="True"
                                        BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2"
                                        ForeColor="Black" GridLines="None" PageSize="5" CssClass="estilo">
                                        <Columns>
                                            <asp:CommandField SelectText="Elegir" ShowSelectButton="True" />
                                            <asp:BoundField DataField="cod_funcionario" HeaderText="cod_funcionario" InsertVisible="False"
                                                ReadOnly="True" SortExpression="cod_funcionario" Visible="False" />
                                            <asp:BoundField DataField="codigo" HeaderText="Codigo" SortExpression="codigo">
                                                <HeaderStyle Width="80px" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="funcionario" HeaderText="Funcionario" ReadOnly="True"
        ...
        <tr>
            <td style="text-align: center" class="label">
                <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                    <ProgressTemplate>
                        &nbsp;&nbsp;<img src="images/progreso2.gif" style="width: 24px; height: 24px" />&nbsp;&nbsp;<br />
